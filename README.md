...
- TIME based question how have specific time input fields.
...
- Bug fix caused by changing מבחן to מבדק accross the site 

### 0.3.4

- Changed quiz script so not every quiz has it's nav buttons disabled
- Only the first completed quiz of every course gets removed after being quiz_completed 

### 0.3.3

- Working text questions and basic report creation
...
- Changed is_time to exercise_type
- Added Reports admin page for generating xlsx of all resutlts of specified exercies
- Moved to 0.3.0 since is_time might be breaking
